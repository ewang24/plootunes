...
// Cover storage convention (this file is serve-only config; covers are written elsewhere):
...
// - The thumbnail is stored alongside it as `{basename}_thumb.webp`, and the client
//   derives its URL as `${publicBasePath}/${basename}_thumb.webp`.
